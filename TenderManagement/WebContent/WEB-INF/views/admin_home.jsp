  ...
  <header>
    ...
    <aside>
      <div class="list-group">
          <button onclick="loadAdminDashBoard()" class="list-group-item  list-group-item-action d-flex justify-content-between align-items-center">
            <i class="fa fa-home" style="font-size:20px;"></i>
            <!-- <a href="admin_home.html" style="color:inherit;text-decoration: none"> Home</a> -->
            Home</button>
        <button class="dropdown-btn list-group-item  list-group-item-action d-flex justify-content-between align-items-center">
        <span><i class="fa fa-bars" style="font-size:20px;"></i></span>
          Employee
        </button>
         <div class="dropdown-container">
          <ul class="list-group">
          <li class="list-group-item list-group-item-action"><a href="#">Add Employee</a></li>
          <li class="list-group-item list-group-item-action"><a href="#">View Employees</a></li>
        </ul>
        </div>
        <button class="dropdown-btn list-group-item  list-group-item-action d-flex justify-content-between align-items-center">
         <span><i class="fa fa-bars" style="font-size:20px;"></i></span>
         ...
         <div class="dropdown-container">
          <ul class="list-group">
          <li class="list-group-item list-group-item-action"><a href="#">View Suppliers</a></li>
        </ul>
        </div>
        <button class="dropdown-btn list-group-item  list-group-item-action d-flex justify-content-between align-items-center">
         <span><i class="fa fa-bars" style="font-size:20px;"></i></span>
          Tenders 
                 ...
                 <div class="dropdown-container">
          <ul class="list-group">
          <li class="list-group-item list-group-item-action"><a href="#">View Tenders</a></li>
          <li class="list-group-item list-group-item-action"><a href="#">Granted Tenders</a></li>
        </ul>
        </div>
    ...
    <section id="section">
      <path >
        ...
        <strong style="padding-left:15px;">Admin Home</strong style="padding-left:15px;">
        </lable>
      </path>
