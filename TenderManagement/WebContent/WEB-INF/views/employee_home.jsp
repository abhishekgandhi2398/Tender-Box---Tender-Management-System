  ...
  <header>
    ...
    <aside>
      <div class="list-group">
          <button onclick="loadEmployeeDashBoard()" class="list-group-item  list-group-item-action d-flex justify-content-between align-items-center">
            <i class="fa fa-home" style="font-size:20px;"></i>
            <!-- <a href="admin_home.html" style="color:inherit;text-decoration: none"> Home</a> -->
            Home</button>
        <button class="dropdown-btn list-group-item  list-group-item-action d-flex justify-content-between align-items-center"><i class="fa fa-bars" style="font-size:20px;"></i>
          Suppliers
        </button>
    ...
    <section id="section">
      <path >
        ...
        <strong style="padding-left:15px;">Employee Home</strong style="padding-left:15px;">
        </lable>
      </path>
      <contentBox id="contentBox"> </contentBox>
    </section> 
    <script>
    window.onload=loadEmployeeDashBoard;     
