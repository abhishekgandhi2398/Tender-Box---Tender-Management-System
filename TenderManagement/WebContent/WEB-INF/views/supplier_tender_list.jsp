...
<div style="margin:0 15px 0 15px;padding:5px">
 ...
 <table class="table table-hover table-striped table-light" id="supplierTenderListTable">
    <thead>
   <tr>
  ...
  <tbody>
        ...
        <tr class="">
            ...
            <td><button type="button" class="btn btn-outline-info btn-block" onclick="loadApplyQuotation(this)">Apply for this Tender</button></td>
        </tr>
    </c:forEach>
   </tbody>
</table>
